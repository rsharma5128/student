...
flowchart LR
    subgraph Day_1[Day 1-7 Computer Setup]
        ...
        C[Days 8-9<br/><br/>Website File editing<br/><br/>Taught how to create files in repositories<br/>Reflected on journey through days 1-7<br/>Learn basic Mermaid and Markdown(optional)]:::daytres
end
A --> B
B --> C
```
